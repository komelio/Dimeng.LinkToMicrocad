...
namespace Offset
{
    ...
    public static class GeometryCalculations
    {
        ...
        public static Line PositiveLineSegmentOffsetPoint2d(Point2d p1, Point2d p2,double offsetDistance)
        {
            ...
            return lineOffsetSegment;
        }

        public static Line NegativeLineSegmentOffsetPoint2d(Point2d p1, Point2d p2, double offsetDistance)
        {
            return PositiveLineSegmentOffsetPoint2d(p1, p2, -offsetDistance);
        }

        public static Arc PositiveArcSegmentOffsetPoint2d(SEG seg1, SEG seg2, double offsetDistance)
        {
            ...
            return GetArcFrom3Point2d(center, startArcSegPoint, endArcSegPoint);
        }

        public static Arc NegativeArcSegmentOffsetPoint2d(SEG seg1, SEG seg2, double offsetDistance)
        {
            return PositiveArcSegmentOffsetPoint2d(seg1, seg2, -offsetDistance);
        }
        ...
        public static Arc GetArcFrom3Point2d(Point2d center, Point2d start, Point2d end)
        {
