...
{
    public class SHELFMachiningToken : BaseToken
    {
        public SHELFMachiningToken(string token, string par1, string par2, string par3, string par4, string par5, string par6, string par7, string par8, string par9, int row, int column, Part p)
        ...
        public override bool Valid(Logger logger)
        {
            ...
            DistToBottom = base.DoubleChecker(this.Par1, "关联的层板孔（类型2）/到底部距离", true);
            DistToFirstHole = base.DoubleChecker(this.Par2, "关联的层板孔（类型2）/至第1排孔的距离", false);
            FaceHoleDepth = base.DoubleChecker(this.Par3, "关联的层板孔（类型2）/面孔深度", true);
            DistToTop = base.DoubleChecker(this.Par4, "关联的层板孔（类型2）/至顶部的距离", true);
            DistToSecondHole = base.DoubleChecker(this.Par5, "关联的层板孔（类型2）/至第二排孔的距离", false);
            FaceHoleDiameter = base.DoubleChecker(this.Par6, "关联的层板孔（类型2）/面孔直径", true);
            DistBetweenTwoHoles = string.IsNullOrEmpty(this.Par7) ? 32 : base.DoubleChecker(this.Par7, "关联的层板孔（类型2）/面孔直径", true);
            GapDist = base.DoubleChecker(Par8, "关联的层板孔（类型2）/两孔距离", true);
